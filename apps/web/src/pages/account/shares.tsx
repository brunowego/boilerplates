                      ...
                      <ActionIcon
                        ...
                        onClick={() => {
                          if (window.isSecureContext) {
                            clipboard.copy(`${setting.get('general.appUrl')}/share/${share.id}`)
                            toast.success('Your link was copied to the keyboard.')
                          } else {
                            showShareLinkModal(modals, share.id, setting.get('general.appUrl'))
                          }
                        }}
                      >
                        <TbLink />
                      ...
                      <ActionIcon
                        ...
                        onClick={() => {
                          modals.openConfirmModal({
                            ...
                            children: (
                              <Text size="sm">Do you really want to delete this share?</Text>
                            ),
                            confirmProps: {
                              color: 'red',
                            },
