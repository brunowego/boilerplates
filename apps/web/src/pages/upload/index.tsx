...
const Upload = ({
  ...
  maxShareSize ??= parseInt(setting.get('share.maxSize'))
    ...
    if (
      ...
      shareService
        ...
        .then((share) => {
          ...
          showCompletedUploadModal(modals, share, setting.get('general.appUrl'))
          setFiles([])
        })
          ...
          onClick={() => {
            showCreateUploadModal(
              modals,
              {
                ...
                isReverseShare,
                appUrl: setting.get('general.appUrl'),
                allowUnauthenticatedShares: setting.get('share.allowUnauthenticatedShares'),
                enableEmailRecepients: setting.get('email.enableShareEmailRecipients'),
              },
              uploadFiles
            )
          }}
