...
import { Wise as WiseIcon } from '@acme/ui/components/logo'

import { FADE_IN_ANIMATION_SETTINGS } from '@/constants/framer-motion'

export default function Wise(): JSX.Element {
  ...
  return (
    <>
      <div className='flex items-center space-x-4'>
        <Label className='grow space-x-1.5 font-medium' htmlFor='wise'>
          <WiseIcon className='size-8' />

          <span className='font-medium text-base'>Wise</span>
        </Label>

        <Switch id='wise' onClick={() => setExpanded(!expanded)} />
      </div>
