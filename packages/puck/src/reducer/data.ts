...
import type { Config, Content, Data } from '../types/Config'
...
import type { PuckAction, ReplaceAction } from './actions'
...
export const reduceData = (data: Data, action: PuckAction, config: Config) => {
  ...
  if (action.type === 'duplicate') {
    // biome-ignore lint/style/noNonNullAssertion: We know the item exists
    const item = getItem(
