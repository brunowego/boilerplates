...
import type { DefaultComponentProps, UiState } from './Config'
...
export type SpacingField = BaseField & {
  type: 'spacing'
}

export type AlignField = BaseField & {
  type: 'align'
}

export type TailwindCSSField = BaseField & {
  type: 'tailwindcss'
}
