        ...
        <Body className="bg-white p-3">
          <Container className="max-w-xl">
            <Section className="my-4">
              <Img src={absoluteUrl('/static/logo.png')} alt={process.env.APP_NAME} width={160} />
            </Section>
            ...
            <Section className="mt-4 text-sm text-slate-500">
              ...
              &nbsp;&nbsp;&bull;&nbsp;&nbsp;
              <Link className="font-sans text-slate-500" href="https://github.com/acme">
                Github
              </Link>
              &nbsp;&nbsp;&bull;&nbsp;&nbsp;
              <Link
                className="font-sans text-slate-500"
                href={`mailto:${process.env.EMAIL_CONTACT_ADDRESS}`}
              >
                Contact
              </Link>
            </Section>
